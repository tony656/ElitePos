            ...
            <div class="wrap">
                ...
                <div class="tbl-wrap au au4">
                    ...
                    <div class="empty-state" style="padding:3.5rem 1.5rem;">
                        <i class="bi bi-coin" style="font-size:2.5rem; display:block; margin-bottom:.75rem; opacity:.3;"></i>
                            ...
                            <tr data-search="{{ strtolower($chip->shop->name ?? '') }} {{ strtolower($chip->created_by ?? '') }}">
                                ...
                                <td>
                                    <div class="action-btns">
                                        ...
                                        <form action="/banking-chip/delete/{{ $chip->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this chip entry? This will recalculate all subsequent entries.');">
                                            @csrf
...
<div class="modal fade" id="addChipModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/banking-chip/store" method="post">
                @csrf
...
<div class="modal fade" id="editChip{{ $chip->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/banking-chip/update/{{ $chip->id }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="field-row" style="margin-bottom:12px;">
                        <div class="field">
...
<script>
    function applyFilters() {
        ...
        window.location.href = '{{ url("/banking-chips") }}?' + params.toString();
    }
</script>
</body>
</html>