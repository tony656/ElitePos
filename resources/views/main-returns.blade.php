        ...
        <div class="main-wrap">
            ...
            <div class="returns-panel">
                <div class="panel-head">
                    ...
                    <form method="GET" action="{{ url('view-returns') }}" class="filter-row">
                        ...
                        <table class="returns-tbl">
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    $from = DB::table('users')->where('id', $item->account)->value('name');
                                @endphp
                                <tr id="row-{{ $item->productId }}">
                                    ...
                                    <td><i class="bi bi-person"></i> {{ $supName ?? 'Unknown' }}</td>
                                    <td><i class="bi bi-person-check"></i> {{ $from ?? 'Unknown' }}</td>
                                    <td>
