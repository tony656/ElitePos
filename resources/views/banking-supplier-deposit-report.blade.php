    ...
    <main class="main-content">
        <div class="main-wrap">
            ...
            <div class="pg-header">
                ...
                <a href="/banking/supplier-deposit-report/export?{{ http_build_query(request()->query()) }}" class="btn-export">
...
<script>
    $(document).ready(function() {
        ...
        function fetchSuppliersByShop(shopId, callback) {
            ...
            $.ajax({
                url: '/banking/get-suppliers-by-shop',
                type: 'GET',
                data: {
                    shop_id: shopId,
                    date_from: dateFrom,
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        let options = '<option value="">{{ __('messages.all_suppliers') }}</option>';
                        ...
                        supplierSelect.html('<option value="">{{ __('messages.all_suppliers') }}</option>');
                    }
                },
