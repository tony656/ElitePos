        ...
        <div class="main-wrap">
            ...
            <div class="pg-header">
                <div class="pg-title-wrap">
                    ...
                    <div class="pg-title">
                        Main Store Customer <span>Management</span>
                    </div>
                </div>

                <a href="{{ url('settings') }}" class="hbtn-primary" style="margin-left: 10px;">
                ...
                <div class="table-wrap">
                    <table class="cust-tbl" id="customersTable">
                        ...
                        <tbody id="customersBody">
                            ...
                            @else
                                @foreach ($accounts as $index => $customer)
                                <tr class="customer-row"
                                  >
                                    
                                    <td>{{ $index + 1 }}</td>
                                    <td><div class="cust-name">{{ $customer->name }}</div></td>
                                    <td><div class="cust-phone">{{ $customer->location }}</div></td>
