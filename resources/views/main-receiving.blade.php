            ...
            <div class="main-wrap">
                ...
                <div class="pg-header">
                    <div class="pg-title">
                        ...
                        {{ __('messages.main_store_receiving_page_header') }}
                    </div>
                    <div class="header-actions">
                       
                        <a href="{{ url('main-receivings') }}" class="hbtn hbtn-outline">
                            <i class="bi bi-list-check"></i> {{ __('messages.view_receivings') }}
                        </a>
                        <a href="{{ url('main-return') }}" class="hbtn hbtn-outline-rose">
                                ...
                                <div class="field-grid" style="margin-bottom:0.65rem;">
                                    ...
                                    <div class="field">
                                        ...
                                        <select name="served" id="served" class="field-input" required>
                                            ...
                                            @foreach (DB::table('users')->where('account', 7)->get() as $user)
