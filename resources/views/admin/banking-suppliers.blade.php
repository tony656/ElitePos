                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end action-buttons" data-label="Actions">
                                                ...
                                                <form action="/admin/banking-supplier/delete/{{ $supplier->id }}"
                                                      method="POST"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/banking-supplier/update/{{ $supplier->id }}" method="post">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="addAccount{{ $supplier->id }}-supplier" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/banking-supplier/account/store/{{ $supplier->id }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Bank Name <span class="text-danger">*</span></label>
        ...
        <div class="modal fade" id="editAccount{{ $account->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/admin/banking-supplier/account/update/{{ $account->id }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Bank Name <span class="text-danger">*</span></label>
    ...
    <div class="modal fade" id="addBankingSupplier" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/banking-supplier/store" method="post">
                        @csrf
