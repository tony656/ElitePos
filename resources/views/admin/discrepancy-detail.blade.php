    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .resolution-box-title {
            font-size: 13px; font-weight: 600; margin-bottom: 0.75rem;
        }

        textarea {
            width: 100%; border: 1px solid var(--border-md); border-radius: var(--radius-sm);
            padding: 0.75rem; font-family: var(--font); font-size: 13px;
...
<div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        ...
        <div class="page-header">
            <div>
                <a href="{{ url('admin/balance-check/discrepancies/' . $discrepancy->shop_id . '/' . $discrepancy->balance->balance_date) }}" class="back-link">← Back to Discrepancies</a>
            ...
            <div class="header-actions">
                ...
                <form method="POST" action="{{ url('admin/balance-check/resolve/' . $discrepancy->id) }}" id="resolveForm" style="display: inline;">
                    @csrf
                    <button type="button" class="btn-primary" onclick="showResolutionModal()">
                        ✓ Mark as Resolved
                    </button>
                </form>
                @endif
                <a href="{{ url('admin/balance-check/all') }}" class="btn-icon">
        ...
        <div class="resolution-box">
            <div class="resolution-box-title">Resolve This Discrepancy</div>
            <form method="POST" action="{{ url('admin/balance-check/resolve/' . $discrepancy->id) }}" id="resolveFormInline">
                @csrf
...
<div class="modal-overlay" id="resolutionModal">
    <div class="modal-box" style="max-width: 500px;">
        ...
        <form method="POST" action="{{ url('admin/balance-check/resolve/' . $discrepancy->id) }}">
            @csrf
