...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-ghost { display:inline-flex; align-items:center; gap:6px; padding:8px 14px; border-radius:var(--r); background:rgba(255,255,255,.07); border:1px solid rgba(255,255,255,.16); color:rgba(255,255,255,.75); font-family:var(--font); font-size:13px; font-weight:500; cursor:pointer; transition:all .15s; text-decoration:none; }
        ...
        .ct-val { font-family:var(--mono); font-size:18px; font-weight:600; line-height:1; }
        ...
        .filter-ctrl { width:100%; font-family:var(--font); font-size:13px; padding:8px 12px; border:1.5px solid var(--slate-200); border-radius:var(--r); background:var(--white); color:var(--slate-800); outline:none; transition:border-color .18s, box-shadow .18s; }
        ...
        .btn-filter { display:inline-flex; align-items:center; gap:5px; padding:8px 16px; border-radius:var(--r); background:var(--navy); color:var(--white); font-family:var(--font); font-size:13px; font-weight:600; border:none; cursor:pointer; transition:all .15s; }
        .btn-filter:hover { background:var(--navy-light); }
        .btn-reset  { display:inline-flex; align-items:center; gap:5px; padding:8px 14px; border-radius:var(--r); border:1.5px solid var(--slate-200); background:transparent; font-family:var(--font); font-size:13px; color:var(--slate-600); cursor:pointer; text-decoration:none; transition:all .15s; }
        .btn-reset:hover { background:var(--slate-100); }

        .date-active-badge { display:inline-flex; align-items:center; gap:5px; margin-bottom:1rem; background:var(--navy-mid); color:rgba(255,255,255,.8); padding:4px 12px; border-radius:20px; font-size:12px; font-family:var(--mono); }
        ...
        .date-section-head span { font-size:11.5px; color:rgba(255,255,255,.45); margin-left:auto; font-family:var(--mono); }
        ...
        .amt-val   { font-family:var(--mono); font-size:15px; font-weight:600; color:var(--slate-800); }
        ...
        .progress-labels { display:flex; justify-content:space-between; font-size:11px; color:var(--slate-400); font-family:var(--mono); }
        ...
        .qty-pill   { display:inline-flex; align-items:center; padding:2px 8px; background:var(--slate-100); border-radius:20px; font-size:11px; font-weight:600; color:var(--slate-600); font-family:var(--mono); }
        .price-mono { font-family:var(--mono); font-size:12.5px; font-weight:600; }
        .date-mono  { font-family:var(--mono); font-size:11px; color:var(--slate-400); }

        .btn-undo { display:inline-flex; align-items:center; gap:4px; padding:4px 10px; border-radius:var(--r); background:rgba(11,30,61,.07); color:var(--navy-light); border:none; font-family:var(--font); font-size:11.5px; font-weight:600; cursor:pointer; transition:all .15s; }
        ...
        .inv-pill { display:inline-flex; align-items:center; gap:4px; padding:3px 9px; border-radius:20px; background:rgba(11,30,61,.07); color:var(--navy); font-size:11px; font-weight:700; font-family:var(--mono); }
        ...
        .tbl-qty   { font-family:var(--mono); font-size:12.5px; color:var(--slate-600); }
        .tbl-price { font-family:var(--mono); font-weight:600; color:var(--slate-800); }
        .tbl-total { font-family:var(--mono); font-weight:700; color:var(--emerald); }
        .tbl-date  { font-family:var(--mono); font-size:11.5px; color:var(--slate-400); }
        ...
        .btn-confirm { padding:9px 20px; border-radius:var(--r); background:var(--emerald); color:var(--white); border:none; font-family:var(--font); font-size:13px; font-weight:700; cursor:pointer; display:flex; align-items:center; gap:6px; box-shadow:0 3px 14px rgba(5,150,105,.25); transition:all .18s; }
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
            <div class="wrap">
                ...
                <div class="breadcrumb au au1">
                    <a href="{{ url('admin/shopInvoices') }}" class="bc-link"><i class="bi bi-shop"></i> Shops</a>
                    <span class="bc-sep">/</span>
                    <a href="{{ url('admin/shopDebtors/' . urlencode($shopName)) }}" class="bc-link">{{ $shopName }}</a>
                    <span class="bc-sep">/</span>
                ...
                <div class="filter-card au au2">
                    <form action="{{ url('admin/customerDebtProducts') }}" method="post">
                        @csrf
                        ...
                        <div class="filter-row">
                            ...
                            <div class="filter-actions">
                                ...
                                <button type="submit" name="reset" value="1" class="btn-reset"><i class="bi bi-x"></i> Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div id="cardView">
                    ...
                    @forelse($groupedByDate as $date => $dayItems)
                        ...
                        <div class="invoice-card">
                            ...
                            {{-- Description band --}}
                            <div class="items-desc-band">
                                <i class="bi bi-box-seam"></i>
                                <div class="items-desc-text">{{ $itemDesc }}</div>
                            </div>
                                                    ...
                                                    <table class="card-tbl" style="margin-bottom:0;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:right; font-family:var(--mono); font-size:12.5px;">
                                                                    {{ number_format($product->productPrice ?? 0) }}
                                                                </td>
                                                                <td style="text-align:right; font-family:var(--mono); font-weight:600; color:var(--emerald);">
