...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { font-family: var(--font); background: #ECF0F8; color: var(--slate-800); font-size: 14px; line-height: 1.6; }
        ...
        .tool-sub   { font-size: 11.5px; color: var(--slate-400); font-family: var(--mono); margin-left: 8px; }
        .toolbar-right { display: flex; gap: 8px; }

        .btn-back { display: inline-flex; align-items: center; gap: 6px; padding: 7px 14px; border-radius: var(--r); border: 1.5px solid var(--slate-200); background: transparent; font-family: var(--font); font-size: 13px; color: var(--slate-600); cursor: pointer; transition: all .15s; text-decoration: none; }
        .btn-back:hover { background: var(--slate-100); color: var(--slate-800); }
        .btn-print { display: inline-flex; align-items: center; gap: 6px; padding: 7px 16px; border-radius: var(--r); border: none; background: var(--navy); color: var(--white); font-family: var(--font); font-size: 13px; font-weight: 600; cursor: pointer; transition: all .15s; box-shadow: 0 2px 8px rgba(11,30,61,.2); }
        ...
        .rcpt-id   { font-family: var(--mono); font-size: 13px; color: rgba(255,255,255,.55); margin-top: 6px; }
        ...
        .barcode-font { font-family: 'Libre Barcode 128', cursive; font-size: 2.75rem; color: var(--white); line-height: 1; display: block; }
        .barcode-text { font-family: var(--mono); font-size: 10.5px; color: rgba(255,255,255,.4); margin-top: 3px; letter-spacing: .1em; }
        ...
        .info-value { font-size: 12.5px; font-weight: 600; color: var(--slate-800); text-align: right; font-family: var(--mono); }
        .info-value.plain { font-family: var(--font); }
        ...
        .items-table td:last-child { text-align: right; font-family: var(--mono); font-weight: 600; color: var(--slate-800); }

        .idx-cell  { font-size: 11.5px; color: var(--slate-400); font-family: var(--mono); width: 32px; }
        .prod-btn  {
        ...
        .qty-chip  { display: inline-block; padding: 2px 9px; border-radius: 20px; background: var(--slate-100); color: var(--slate-600); font-family: var(--mono); font-size: 12px; font-weight: 600; }
        ...
        .total-val   { font-family: var(--mono); font-weight: 600; color: var(--slate-800); }
        ...
        .grand-val   { font-family: var(--mono); font-size: 18px; font-weight: 700; color: var(--amber); }
        ...
        .footer-meta   { font-size: 11px; color: var(--slate-300); font-family: var(--mono); }
    ...
    <div class="receipt">
        ...
        <div class="rcpt-header">
            <div class="rcpt-header-inner">
                ...
                <div class="rcpt-badge">
                    <div class="rcpt-type">Receipt</div>
                    <div class="rcpt-id">#{{ $sales->sales_id ?? '000000' }}</div>
                </div>
            </div>
            <div class="barcode-row">
                <span class="barcode-font">*{{ $sales->sales_id ?? '000000' }}*</span>
                <div class="barcode-text">{{ $sales->salesName ?? 'N/A' }}</div>
            </div>
        </div>
        ...
        <div class="rcpt-body">
            ...
            <div class="items-section">
                ...
                <div style="border-radius:var(--r-lg); overflow:hidden; border:1.5px solid var(--slate-200);">
            ...
            <div class="totals-block">
                <div class="total-row">
                    ...
                    <span class="total-val">Tsh {{ number_format($grandTotal) }}</span>
                </div>

                @if(($sales->discount ?? 0) > 0)
                <div class="total-row discount">
                    <span class="total-label">Discount</span>
                    <span class="total-val">− Tsh {{ number_format($sales->discount) }}</span>
                </div>
                @endif
