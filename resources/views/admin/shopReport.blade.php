                    ...
                    <tbody id="shopTableBody">
                        @foreach ($shopReports as $index => $shop)
                            ...
                            <tr class="shop-row {{ !$isBalanced ? 'warn-row' : '' }}"
                                ...
                                <td>
                                    @if(!$isBalanced)
                                        <a href="{{ url('admin/balance-check/discrepancies/' . $shop->shop_id . '/' . $dateParam) }}"
                                           class="ico-warn"
                                ...
                                <td colspan="22">
                                    <div class="detail-inner">
                                        ...
                                        <div style="margin-top:1rem; display: flex; gap: 8px; flex-wrap: wrap;">
                                            ...
                                            <form method="POST" action="{{ url('admin/cashDelete') }}" style="display: inline;" onsubmit="return confirm('Delete cash submission for {{ $shop->shop_name }}?');">
                                                @csrf
...
<div class="modal-overlay" id="cashModal">
    <div class="modal-box">
        ...
        <form id="cashForm" method="POST" action="{{ url('admin/cashSubmit') }}">
            @csrf
