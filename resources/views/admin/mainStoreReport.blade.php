...
<head>
    ...
    <title>Main Store Report — {{ config("app.name") }}</title>
    @include("links")
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .empty-state p { font-family: 'Syne', sans-serif; font-size: 1rem; font-weight: 600; color: var(--gray-400); }
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="wrap">
                ...
                <div class="pg-header animate-in">
                    <div class="header-left">
                        ...
                        <div class="header-title">
                            <div class="header-eyebrow">Account ID: 7 &nbsp;·&nbsp; Outgoing</div>
                            <h1>Main Store Report</h1>
                            <p><i class="bi bi-arrow-right-circle-fill"></i> Stock transfers to shops</p>
                        </div>
                    </div>
                ...
                <!-- ── Filters ── -->
                <form method="GET" action="{{ url('admin/main-store-report') }}" class="filter-card animate-in" style="animation-delay:.08s">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-3">
                            <label class="filter-label"><i class="bi bi-calendar3"></i> From Date</label>
                            <input type="date" name="date_from" class="filter-input" value="{{ $dateFrom }}">
                        </div>
                        <div class="col-md-3">
                            <label class="filter-label"><i class="bi bi-calendar3"></i> To Date</label>
                        ...
                        <div class="col-md-6">
                            <div style="display:flex; gap:.75rem; padding-top:.1rem;">
                                ...
                                <a href="{{ url('admin/main-store-report') }}" class="btn-filter btn-filter-reset" style="text-decoration:none; border:1.5px solid var(--gray-200);">
                ...
                <div class="stats-grid animate-in" style="animation-delay:.16s">
                    <div class="stat-card">
                        ...
                        <div class="stat-sub"><i class="bi bi-box-seam"></i> All requests</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-sub"><i class="bi bi-graph-up-arrow"></i> Processed</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-sub"><i class="bi bi-hourglass-split"></i> Pending payments</div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-sub"><i class="bi bi-exclamation-circle"></i> Awaiting</div>
                    </div>
                </div>
                ...
                <div class="panel animate-in" style="animation-delay:.24s">
                    <div class="panel-header">
                        <div class="panel-header-title">
                            ...
                            Daily Transfer Logs
                            <span class="tx-count">{{ $reportRows->count() }} transactions</span>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="data-table" id="mainTable">
                            ...
                            <tbody>
                                ...
                                <tr class="main-row">
                                    <td class="cell-date">
                                        <i class="bi bi-calendar3" style="color:var(--gray-300); margin-right:.3rem;"></i>{{ $row->date }}
                                    </td>
                                    <td class="cell-shop">
                                    ...
                                    <td>
                                        <span class="cell-value" style="color:var(--success-dark)">
                                            Tsh {{ number_format($row->approved_value) }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div style="display:flex; gap:.25rem; flex-wrap:wrap;">
                                            @if($row->credit_value > 0)
                                                <span class="badge badge-credit"><i class="bi bi-credit-card"></i> Credit</span>
                                            @endif
                                            @if($row->cash_value > 0)
                                    ...
                                    <td>
                                        @if($row->pending_value > 0)
                                            <span class="badge badge-pending">
                                                ...
                                                {{ number_format($row->items->where('status','Submitted')->count() ?? 0) }} Pending
                                            </span>
                                        @else
                                    ...
                                    <td>
                                        @if($row->credit_value > 0)
                                            <form action="{{ route('admin.request.pay') }}" method="POST"
                                                  onsubmit="return confirm('Mark this credit as paid?')"
                                            ...
                                            <div class="details-body">
                                                <div class="details-header">
                                                    <div class="details-title">
                                                        ...
                                                        Item Breakdown
                                                        <span class="details-count">{{ $row->items->count() }} items</span>
                                                    </div>
                                                </div>
                                                <div class="sub-table-wrap">
                                                    <table class="sub-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                            <tr>
                                                                <td class="mono" style="color:var(--gray-400)">#{{ $item->productId }}</td>
