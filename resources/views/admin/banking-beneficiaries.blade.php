...
<body>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end action-buttons" data-label="Actions">
                                                ...
                                                <form action="/admin/banking-beneficiary/delete/{{ $beneficiary->id }}"
                                                      method="POST"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form action="/admin/banking-beneficiary/account/delete/{{ $account->id }}"
                                                                                  method="POST"
                                                                                  style="display: inline;"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/admin/banking-beneficiary/account/update/{{ $account->id }}" method="post">
                            @csrf
                            <div class="row">
    ...
    <div class="modal fade" id="editBankingBeneficiary{{ $beneficiary->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/banking-beneficiary/update/{{ $beneficiary->id }}" method="post">
                        @csrf
                        <div class="mb-3">
    ...
    <!-- Add Bank Account Modals for Each Beneficiary -->
    @if(canUser("add_banking_beneficiary"))
    @foreach ($beneficiaries as $beneficiary)
    <div class="modal fade" id="addAccount{{ $beneficiary->id }}-beneficiary" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Bank Account to {{ $beneficiary->name }}</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/admin/banking-beneficiary/account/store/{{ $beneficiary->id }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Bank Name <span class="text-danger">*</span></label>
    ...
    <div class="modal fade" id="addBankingBeneficiary" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/banking-beneficiary/store" method="post">
                        @csrf
