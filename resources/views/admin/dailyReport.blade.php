                    ...
                    <div class="table-container">
                        <div class="table-header">
                            <div class="table-title">
                                ...
                                Cash Report - {{ date('F Y', strtotime(isset($monthParam) ? $monthParam . '-01' : now())) }}
                            </div>
                            <div class="table-controls">
                                <div class="date-filter">
                                    <label for="filterDateCash"><i class="bi bi-filter"></i> Filter by Date:</label>
                                ...
                                <table class="table" id="cashReportTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="Paid Invoice">Paid Invoice</th>
                ...
                <div class="tab-content active" id="daily-report">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <div class="table-controls">
                                <div class="date-filter">
                                    <label for="filterDateDaily"><i class="bi bi-filter"></i> Filter by Date:</label>
                                ...
                                <table class="table" id="dailyReportTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="Sales - cash submit">C.A - C.S</th>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <button type="button" 
                                                                ...
                                                                title="{{ $submittedCash > 0 ? 'Remaining: '.number_format(($row->Mcash_sales - $row->Mexpenses - $row->receivingsCredit) - $submittedCash) : 'Submit Cash' }}">
                                                            <i class="bi bi-cash-coin"></i> 
                                                            @if(($submittedCash - $cashAmount) > 0)
                                                                Resubmit ({{ number_format(($submittedCash) - ($cashAmount)) }})
                                                            @else
                                                                Cash Submit
                                                            @endif
                                                        </button>
                ...
                <div class="tab-content" id="shop-report">
                    <div class="table-container">
                        <div class="table-header">
                            <div class="table-title">
                                <i class="bi bi-shop"></i>
                                Shop Report - {{ date('F Y', strtotime(isset($monthParam) ? $monthParam . '-01' : now())) }}
                            </div>
                            <div class="table-controls">
                                <div class="date-filter">
                                    <label for="filterShopDate"><i class="bi bi-filter"></i> Filter by Date:</label>
                        ...
                        <div class="table-responsive">
                            @if($shopReport->isEmpty())
                                <div class="empty-state">
                                    ...
                                    <h4 class="empty-state-title">No Shop Data Available</h4>
                                    <p class="empty-state-text">No shop sales data found for the selected period.</p>
                                </div>
                            @else
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <div class="card bg-light border-0">
                                    <div class="card-body p-3">
                                        <small class="text-muted d-block mb-1">Total Sales (Paid)</small>
                            ...
                            <div class="col-6">
                                <div class="card bg-light border-0">
                                    <div class="card-body p-3">
                                        <small class="text-muted d-block mb-1">Credit Sales</small>
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="col-6">
                                <div class="card bg-light border-0">
                                    <div class="card-body p-3">
                                        <small class="text-muted d-block mb-1">Receivings (Paid)</small>
                                        <div class="d-flex align-items-center">
                        ...
                        <div class="card border-success mb-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <span>Paid Sales - Credit - Expenses + Receivings:</span>
                                    <strong id="expectedCash" class="text-success">0</strong>
                                </div>
                                <hr class="my-2">
                                <div class="d-flex justify-content-between">
                                    <span class="fw-bold">Cash to Submit:</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-text text-muted">
                                ...
                                Enter the actual cash amount being submitted
                            </div>
                        </div>
                        <div class="mb-4">
        ...
        <div id="errorToast" class="toast align-items-center text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body">
                    ...
                    Error submitting cash. Please try again.
                </div>
                <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showNoResultsMessage(tableId, filterValue) {
                ...
                if (!message) {
                    ...
                    message.innerHTML = `<i class="bi bi-calendar-x"></i> No results found for ${filterValue}`;
