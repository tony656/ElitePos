    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                ...
                <form method="POST" action="{{ url('admin/balance-check/recalculate/' . $shop->id . '/' . $date) }}" style="display: inline;">
                    @csrf
                    <button type="submit" class="btn-icon" onclick="return confirm('Recalculate balance for this shop?')">
                ...
                @endif
                <a href="{{ url('admin/balance-check/all?date=' . $date) }}" class="btn-icon">
                    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="{{ !$disc->is_resolved ? 'warn-row' : '' }}">
                            ...
                            <td>
                                <a href="{{ url('admin/balance-check/discrepancy/' . $disc->id) }}" class="btn-icon" style="font-size: 11px; padding: 4px 10px;">
                                    Details
                                </a>
                                @if(!$disc->is_resolved)
                                <form method="POST" action="{{ url('admin/balance-check/resolve/' . $disc->id) }}" style="display: inline;" onsubmit="return confirm('Mark this discrepancy as resolved?')">
                                    @csrf
                                    <button type="submit" class="btn-icon" style="font-size: 11px; padding: 4px 10px; background: var(--green); border-color: var(--green); color: white;">
                                        Resolve
                                    </button>
                                </form>
                                @endif
