    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="wrap">
            ...
            <div class="breadcrumb au au1">
                <a href="{{ url('admin/home') }}" class="bc-link"><i class="bi bi-house"></i> Home</a>
                <span class="bc-sep">/</span>
                <a href="{{ url('admin/shopInvoices') }}" class="bc-link">Shop Invoices</a>
                <span class="bc-sep">/</span>
            ...
            <div class="filters-card au au2">
                <form method="GET" action="{{ url('admin/paidInvoices') }}">
                    <div class="filters-row">
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="{{ url('admin/paidInvoices') }}" class="btn-reset">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ url('admin/deletePaidInvoice') }}" method="POST" class="delete-form" style="display:inline;">
                                        @csrf
