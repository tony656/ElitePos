            ...
            <div class="wrap">
                ...
                <div class="pg-header au au1">
                    <div class="pg-left">
                        ...
                        <div class="pg-title-text">
                            <h1>{{ __('messages.shops_with_invoices') }}</h1>
                            <p>{{ __('messages.select_shop_view_customers_debts') }}</p>
                        </div>
                    </div>
                    <div class="pg-right">
                ...
                <div class="controls-bar au au2">
                    <div class="search-wrap">
                        ...
                        <input type="text" id="shopSearch" class="search-input" placeholder="{{ __('messages.search_shops_placeholder') }}">
                    </div>

                    <form method="GET" action="{{ url('shopInvoices') }}" style="display:contents;">
                        ...
                        @if($startDate || $endDate)
                            <a href="{{ url('shopInvoices') }}" class="btn-clear-filter">
                    ...
                    <div class="view-toggle">
                        <button class="view-btn active" id="cardViewBtn" onclick="setView('card')" title="{{ __('messages.card_view') }}">
                            <i class="bi bi-grid-3x3-gap-fill"></i>
                        </button>
                        <button class="view-btn" id="listViewBtn" onclick="setView('list')" title="{{ __('messages.list_view') }}">
                ...
                <div class="metrics-grid au au3">
                    <div class="metric-card mc-navy">
                        <div class="metric-inner">
                            ...
                            <div class="metric-body">
                                <div class="metric-label">{{ __('messages.total_shops') }}</div>
                    ...
                    <div class="metric-card mc-emerald">
                        <div class="metric-inner">
                            ...
                            <div class="metric-body">
                                <div class="metric-label">{{ __('messages.total_invoices') }}</div>
                    ...
                    <div class="metric-card mc-rose">
                        <div class="metric-inner">
                            ...
                            <div class="metric-body">
                                <div class="metric-label">{{ __('messages.total_debts') }}</div>
                ...
                <div id="cardView" class="card-grid au au4">
                    ...
                    @endphp
                    <a href="{{ url('shopDebtors/'.$shop['id']) }}"
                       class="shop-card {{ $allPaid ? 'all-paid' : '' }}"
                       data-name="{{ strtolower($shop['name']) }}">
                        <div class="card-top">
                            <div class="shop-avatar">{{ $initials }}</div>
                            @if($allPaid)
                                <span class="card-badge badge-paid"><i class="bi bi-check-circle-fill"></i> {{ __('messages.all_paid') }}</span>
                            @else
                                <span class="card-badge badge-debt"><i class="bi bi-exclamation-circle-fill"></i> {{ $shop['debt_count'] }} {{ __('messages.debts') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="card-stats">
                            <div>
                                <div class="cs-label">{{ __('messages.invoices') }}</div>
                                <div class="cs-value">{{ $shop['invoice_count'] }}</div>
                            </div>
                       
                            <div>
                                <div class="cs-label">{{ __('messages.shop_debts') }}</div>
                    ...
                    <div style="grid-column:1/-1;">
                        <div class="empty-state">
                            ...
                            <h4>{{ __('messages.no_shops_found') }}</h4>
                            <p>{{ __('messages.no_shops_invoices_recorded') }}</p>
                        </div>
                    </div>
                    @endforelse
                </div>
                    ...
                    <a href="{{ url('shopDebtors/'.$shop['id']) }}"
                       ...
                       data-name="{{ strtolower($shop['name']) }}">
                        ...
                        <div class="list-stats">
                            <div>
                                <div class="ls-label">{{ __('messages.invoices') }}</div>
                                <div class="ls-value">{{ $shop['invoice_count'] }}</div>
                            </div>
                          
                            <div>
                                <div class="ls-label">{{ __('messages.shop_debts') }}</div>
                ...
                <div id="noResults" class="empty-state hidden" style="background:var(--white); border:1.5px solid var(--slate-200); border-radius:var(--r-xl);">
                    <i class="bi bi-search"></i>
                    <h4>{{ __('messages.no_debt_invoices_match_filters') }}</h4>
                    <p>{{ __('messages.no_shops_match_search') }}</p>
                </div>
