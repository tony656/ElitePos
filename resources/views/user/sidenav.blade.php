        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="supplier-menu">
                    <li class="nav-item">
                        <a href="/user/vendors" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/supplier-credit" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="banking-menu">
                    <li class="nav-item">
                        <a href="/user/banking-partners" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/banking-transfers" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                <a href="/user/customers" class="nav-link">
                    <div class="nav-content">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="items-menu">
                    ...
                    <li class="nav-item">
                        <a href="/user/newProducts" class="nav-link">
                            <div class="nav-content">
                    ...
                    @endif
                    <li class="nav-item">
                        <a href="/user/itemRequest" class="nav-link">
                            <div class="nav-content">
                     ...
                     <li class="nav-item">
                        <a href="/user/viewRequest" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="receiving-menu">
                    <li class="nav-item">
                        <a href="/user/make-receiving" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/view-receivings" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/make-return" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                <a href="/user/newOrder" class="nav-link">
                    <div class="nav-content">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="invoices-menu">
                    <li class="nav-item">
                        <a href="/user/ordersList" class="nav-link">
                            <div class="nav-content">
                    ...
                    @if (canUser('view_all_chips'))
                       <li class="nav-item">
                        <a href="/user/banking-chips" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/user/shopInvoices') }}" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/user/paidInvoices') }}" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                ...
                <ul class="submenu" id="report-menu">
                    ...
                    <li class="nav-item">
                        <a href="/user/shopReport" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/fullReport" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/sales" class="nav-link">
                            <div class="nav-content">
                    ...
                    <li class="nav-item">
                        <a href="/user/stock-report" class="nav-link">
                            <div class="nav-content">
                    ...
                    @if (canUser('view_reports'))
                    <li class="nav-item">
                        <a href="/user/offeredProductsReport" class="nav-link">
                            <div class="nav-content">
            ...
            <li class="nav-item">
                <a href="/user/expenses" class="nav-link">
                    <div class="nav-content">
            ...
            <li class="nav-item">
                <a href="/user/employees" class="nav-link">
                    <div class="nav-content">
            ...
            @if (canUser('view_reports'))
            <li class="nav-item">
                <a href="/user/kpi" class="nav-link">
                    <div class="nav-content">
            ...
            @if (canUser('view_ads'))
            <li class="nav-item">
                <a href="/user/ads" class="nav-link">
                    <div class="nav-content">
            ...
            <!-- Account Migration (user only) -->
            @if (Auth::user()->levelStatus === 'user2')
            <li class="nav-item">
                <a href="/user/migration" class="nav-link">
                    <div class="nav-content">
            ...
            <!-- Logout -->
            <li class="nav-item">
                <a href="/user/signout" class="nav-link logout-link">
                    <div class="nav-content">
