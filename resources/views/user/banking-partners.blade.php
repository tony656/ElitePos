                ...
                <div class="metrics-row au au2">
                    <div class="metric-card mc-navy">
                        <div class="metric-inner">
                            ...
                            <div><div class="metric-label">Suppliers</div><div class="metric-value">{{ $suppliers->count() }}</div></div>
                        </div>
                    </div>
                                    ...
                                    <tr data-search="{{ strtolower($supplier->name) }}">
                                        ...
                                        <td>
                                            <div class="action-btns">
                                                ...
                                                <form action="/user/banking-supplier/delete/{{ $supplier->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this supplier?');">
                                                    @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:right;">
                                                                    <div class="action-btns">
                                                                        ...
                                                                        <form action="/user/banking-supplier/account/delete/{{ $account->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this account?');">
                                                                            @csrf
                                                                            <button type="submit" class="act-btn ab-del" title="Delete"><i class="bi bi-trash"></i></button>
                                                                        </form>
                                                                        @endif
                                    ...
                                    <tr data-search="{{ strtolower($beneficiary->name) }}">
                                        ...
                                        <td>
                                            <div class="action-btns">
                                                ...
                                                <form action="/user/banking-beneficiary/delete/{{ $beneficiary->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this beneficiary?');">
                                                    @csrf
                                                    <button type="submit" class="act-btn ab-del" title="Delete"><i class="bi bi-trash"></i></button>
                                                </form>
                                                @endif
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:right;">
                                                                    <div class="action-btns">
                                                                        ...
                                                                        <form action="/user/banking-beneficiary/account/delete/{{ $account->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this account?');">
                                                                            @csrf
                                                                            <button type="submit" class="act-btn ab-del" title="Delete"><i class="bi bi-trash"></i></button>
                                                                        </form>
                                                                        @endif
            ...
            <div class="modal-content">
                ...
                <form action="/user/banking-supplier/account/update/{{ $account->id }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="field" style="margin-bottom:12px;"><label class="field-label">Contact</label><input type="text" class="field-input" name="contact" value="{{ $account->contact }}"></div>
...
<div class="modal fade" id="addAccount{{ $supplier->id }}-supplier" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/user/banking-supplier/account/store/{{ $supplier->id }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="field-row" style="margin-bottom:12px;">
                        <div class="field"><label class="field-label">Bank name <span class="req">*</span></label><input type="text" class="field-input" name="bank_name" placeholder="e.g. CRDB Bank" required></div>
                    ...
                    <div class="field" style="margin-bottom:12px;"><label class="field-label">Contact</label><input type="text" class="field-input" name="contact" placeholder="Contact person"></div>
                    <div class="field" style="margin-bottom:12px;"><label class="field-label">Address</label><input type="text" class="field-input" name="address" placeholder="Branch address (optional)"></div>
                    <div class="field" style="margin-bottom:12px;"><label class="field-label">Description</label><textarea class="field-input" name="description" placeholder="Additional notes (optional)"></textarea></div>
                </div>
                <div class="modal-footer-custom">
                    <button type="button" class="btn-cancel" data-bs-dismiss="modal">Cancel</button>
...
{{-- ══ ADD ACCOUNT MODALS — BENEFICIARIES ══ --}}
@if(canUser("add_banking_beneficiary"))
@foreach($beneficiaries as $beneficiary)
<div class="modal fade" id="addAccount{{ $beneficiary->id }}-beneficiary" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/user/banking-beneficiary/account/store/{{ $beneficiary->id }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="field-row" style="margin-bottom:12px;">
                        <div class="field"><label class="field-label">Bank name <span class="req">*</span></label><input type="text" class="field-input" name="bank_name" placeholder="e.g. CRDB Bank" required></div>
...
{{-- ══ EDIT ACCOUNT MODALS — BENEFICIARIES ══ --}}
@foreach($beneficiaries as $beneficiary)
    @foreach($beneficiary->accounts as $account)
    <div class="modal fade" id="editAccount{{ $account->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
