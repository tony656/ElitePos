        ...
        <div class="pt-3 px-4">
            <div class="card-modern">
                <div class="card-header-modern d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ url('user/shopReport') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body-modern">
                    ...
                    <div class="filter-section">
                        <form method="GET" action="{{ url('user/offeredProductsReport') }}" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ url('user/offeredProductsReport') }}" class="btn btn-outline-secondary ms-2">
