...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .dc-value.mono  { font-family: var(--font-mono); font-size: 12px; color: var(--violet); }
        .dc-value.price { font-family: var(--font-mono); color: var(--navy); }
        ...
        <div class="page-content">
            ...
            <div class="hero-card">
                <div class="product-avatar">
                    @if($products->img)
                        <img src="{{asset('images/' . $products->img)}}" alt="{{$products->name01}}">
                    @else
                ...
                <div class="hero-body">
                    ...
                    <div class="hero-prices">
                        ...
                        <div class="price-group">
                            ...
                            <div class="pval">
                                Tsh {{number_format($products->wholesale)}}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="updateProducts" method="post" enctype="multipart/form-data">
                    ...
                    <div class="img-preview-block">
                        <div class="img-preview-thumb">
                            <img src="{{asset('images/' . $products->img)}}" alt="Current Image">
                        </div>
                        <div style="flex:1;">
