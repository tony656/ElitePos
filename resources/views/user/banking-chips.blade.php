                            ...
                            <tr data-search="{{ strtolower($chip->shop->name ?? '') }} {{ strtolower($chip->created_by ?? '') }}">
                                ...
                                <td>
                                    <div class="action-btns">
                                        ...
                                        <form action="/user/banking-chip/delete/{{ $chip->id }}" method="POST" style="display:contents;" onsubmit="return confirm('Delete this chip entry? This will recalculate all subsequent entries.');">
                                            @csrf
...
<div class="modal fade" id="addChipModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/user/banking-chip/store" method="post">
                @csrf
...
<div class="modal fade" id="editChip{{ $chip->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="/user/banking-chip/update/{{ $chip->id }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="field-row" style="margin-bottom:12px;">
                        <div class="field">
...
<script>
    function applyFilters() {
        ...
        window.location.href = '{{ url("/user/banking-chips") }}?' + params.toString();
    }
</script>
</body>
</html>