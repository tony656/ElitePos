...
<div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        ...
        <div class="page-header">
            <div>
                <a href="{{ url('balance-check/discrepancies/' . $discrepancy->shop_id . '/' . $discrepancy->balance->balance_date) }}" class="back-link">← Back to Discrepancies</a>
            ...
            <div class="header-actions">
                ...
                <form method="POST" action="{{ url('balance-check/resolve/' . $discrepancy->id) }}" id="resolveForm" style="display: inline;">
                    @csrf
                ...
                @endif
                <a href="{{ url('balance-check/all') }}" class="btn-icon">
        ...
        <div class="resolution-box">
            ...
            <form method="POST" action="{{ url('balance-check/resolve/' . $discrepancy->id) }}" id="resolveFormInline">
                @csrf
...
<div class="modal-overlay" id="resolutionModal">
    <div class="modal-box" style="max-width: 500px;">
        ...
        <form method="POST" action="{{ url('balance-check/resolve/' . $discrepancy->id) }}">
            @csrf
