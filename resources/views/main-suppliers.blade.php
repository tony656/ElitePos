                ...
                <div class="pg-header au au1">
                    <div class="pg-left">
                        ...
                        <div class="pg-title-text">
                            <h1>{{ __('messages.main_store_suppliers') }}</h1>
                            <p><i class="bi bi-database"></i> {{ count($fetch) }} {{ __('messages.active_suppliers') }}</p>
                        </div>
                    </div>
                    <div class="pg-right">
                        ...
                        <button class="btn-amber" data-bs-toggle="modal" data-bs-target="#addSupplierModal">
                            <i class="bi bi-plus-lg"></i> {{ __('messages.new_suppliers') }}
                        </button>
                    </div>
                </div>
                ...
                <div class="panel au au5">
                    <div class="panel-head">
                        <div class="panel-head-left">
                            ...
                            <span class="panel-title">{{ __('messages.suppliers') }}</span>
